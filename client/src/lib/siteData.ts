...
export const SERVICE_AREAS = [
  {
    ...
    state: "NC",
    county: "Lee County",
    description: "Headquartered in Sanford, MG Salvage is your local junk car buyer. We offer same-day pickup, free towing, and instant cash offers for vehicles in any condition throughout Lee County.",
    highlights: ["Same-day pickup available", "Local headquarters", "Serving all of Lee County"],
  },
  {
    slug: "fayetteville",
    name: "Fayetteville",
    ...
    description: "MG Salvage provides fast junk car removal and cash offers throughout Fayetteville and Cumberland County. Whether your vehicle runs or not, we'll pick it up for free and pay you on the spot.",
    highlights: ["Free towing across Cumberland County", "Cash on the spot", "Military-friendly service"],
  },
  {
    slug: "pittsboro",
    name: "Pittsboro",
    ...
    description: "Serving Pittsboro and Chatham County, MG Salvage makes selling your junk car simple. Get a free estimate, schedule a pickup, and receive cash — all in the same day.",
    highlights: ["Chatham County coverage", "Fast response times", "No-hassle process"],
  },
  {
    slug: "carthage",
    name: "Carthage",
    state: "NC",
    county: "Moore County",
    description: "MG Salvage serves Carthage and Moore County with reliable junk car removal services. We buy vehicles in any condition — running, non-running, wrecked, or abandoned.",
    highlights: ["Moore County service area", "All vehicle conditions accepted", "Free estimates"],
  },
  {
    slug: "lillington",
    name: "Lillington",
...
export const FAQS = [
  ...
  },
  {
    ...
    answer: "Simply fill out our online estimate form or call us directly. Provide basic details about your vehicle — year, make, model, and condition — and we'll give you a fair cash offer, usually within minutes.",
  },
  {
